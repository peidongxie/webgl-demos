...
type DemoState = StateWithRoot<{
  ...
  points: Tuple<Tuple<Tuple<Tuple<number, 9>, 4>, 6>, 6>;
    ...
    (canvas: HTMLCanvasElement, gl: WebGLRenderingContext) => {
      ...
      draw({
        points: [
          ...
          [
            [
              [2, 10, 2, 1, 0.4, 0, 0, 0, 1],
              [-2, 10, 2, 1, 0.4, 0, 0, 0, 1],
              [-2, 0, 2, 1, 0.4, 0, 0, 0, 1],
              [2, 0, 2, 1, 0.4, 0, 0, 0, 1],
            ],
            [
              [2, 10, 2, 1, 0.4, 0, 1, 0, 0],
              [2, 0, 2, 1, 0.4, 0, 1, 0, 0],
              [2, 0, -2, 1, 0.4, 0, 1, 0, 0],
              [2, 10, -2, 1, 0.4, 0, 1, 0, 0],
            ],
            [
              [2, 10, 2, 1, 0.4, 0, 0, 1, 0],
              [2, 10, -2, 1, 0.4, 0, 0, 1, 0],
              [-2, 10, -2, 1, 0.4, 0, 0, 1, 0],
              [-2, 10, 2, 1, 0.4, 0, 0, 1, 0],
            ],
          ...
          [
            [
              [0.5, 2, 0.5, 1, 0.4, 0, 0, 0, 1],
              [-0.5, 2, 0.5, 1, 0.4, 0, 0, 0, 1],
              [-0.5, 0, 0.5, 1, 0.4, 0, 0, 0, 1],
              [0.5, 0, 0.5, 1, 0.4, 0, 0, 0, 1],
            ],
            [
              [0.5, 2, 0.5, 1, 0.4, 0, 1, 0, 0],
              [0.5, 0, 0.5, 1, 0.4, 0, 1, 0, 0],
              [0.5, 0, -0.5, 1, 0.4, 0, 1, 0, 0],
              [0.5, 2, -0.5, 1, 0.4, 0, 1, 0, 0],
            ],
            [
              [0.5, 2, 0.5, 1, 0.4, 0, 0, 1, 0],
              [0.5, 2, -0.5, 1, 0.4, 0, 0, 1, 0],
              [-0.5, 2, -0.5, 1, 0.4, 0, 0, 1, 0],
              [-0.5, 2, 0.5, 1, 0.4, 0, 0, 1, 0],
            ],
