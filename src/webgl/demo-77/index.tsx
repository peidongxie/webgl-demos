...
type DemoState1 = StateWithRoot<{
  ...
  indexArrays: Tuple<Uint16Array, 2>;
  mvpMatrices: Tuple<Matrix4, 2>;
  points: [Tuple<Tuple<number, 3>, 3>, Tuple<number, 3>[]];
  surfaces: [
    Tuple<Tuple<Tuple<number, 3>, 1>, 1>,
    Tuple<Tuple<number, 3>, 2>[],
  ];
...
type DemoState2 = StateWithRoot<{
  ...
  points: [Tuple<Tuple<number, 6>, 3>, Tuple<number, 6>[]];
  surfaces: [
    Tuple<Tuple<Tuple<number, 3>, 1>, 1>,
    Tuple<Tuple<number, 3>, 2>[],
  ];
 ...
 * 绘制曲面阴影
 */
const Demo77: FC<ComponentProps> = () => {
  ...
  const handleProgramInit = useCallback(
    (canvas: HTMLCanvasElement, gl: WebGLRenderingContext) => {
        ...
        (program) => ({
          ...
          positionArrays: {
            ...
            data: [
              ...
              new Float32Array(3 * (DIVISION + 1) * (DIVISION + 1)),
            ],
          ...
          indexArrays: {
            ...
            data: [
              new Uint16Array(3 * 1),
              new Uint16Array(3 * 2 * DIVISION * DIVISION),
            ],
        ...
        (program) => ({
          ...
          positionColorArrays: {
            ...
            data: [
              ...
              new Float32Array(6 * (DIVISION + 1) * (DIVISION + 1)),
            ],
      ...
      const scales: Tuple<Tuple<number, 3>, 2> = [
        [1, 1, 1],
        [3, 3, 3],
      ];
      const translations: Tuple<Tuple<number, 3>, 2> = [
        [0, 0, 0],
        [0, -0.7, 0],
      ];
      const camera: Tuple<number, 9> = [0, 7, 2, 0, 0, 0, 0, 1, 0];
