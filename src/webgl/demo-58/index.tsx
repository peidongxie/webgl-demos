...
const Demo58: FC<ComponentProps> = () => {
  ...
  useEffect(() => {
    ...
    setDeps((deps) => [deps[0], deps[1], mvpMatrix, deps[3], deps[4]]);
  }, [mvpMatrix]);
  ...
  useEffect(() => {
    ...
    setDeps((deps) => [deps[0], deps[1], deps[2], lightColor, deps[4]]);
  }, [lightColor]);
  ...
  useEffect(() => {
    ...
    setDeps((deps) => [deps[0], deps[1], deps[2], deps[3], lightDirection]);
  }, [lightDirection]);
